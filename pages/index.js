    ...
    <>
      ...
      <div className="space-y-2 pt-6 pb-4 md:space-y-5">
        ...
        <p className="space-y-4 text-zinc-500 dark:text-slate-300">
          <p className="my-4 leading-loose">
            Hi! I'm a fourth-year Honour of Computer Science student at{' '}
            <a
            ...
            concentrating in Internet and Cyber Security graduating in April 2023 looking for new
            graduate job opportunities.<br></br> <br></br>
            My numerous passions include Internet Security, FINTECH (Financial technology), Web-App
            Development, Web 3.0 & Cryptocurrency. Professional experience wise I have explored
            numerous sectors: starting as a Junior Analyst & later moving to Cloud & AI/Machine
            ...
            {'. '}
            <br></br>A summer internship as a Front-End Dev doing Javascript/React.JS development @
            {''}
            <a
            ...
            <br></br>
            <br></br>I possess a range of technical skills with knowledge in C++, Javascript,
            Python, SQL, Java, C#, and much more! I am always looking for a challenge and new
            opportunities to grow not only in my coding skills but as an individual! Hopefully, some
            new and exciting projects are on the way{' '}
            <a className="text-white opacity-0 hover:opacity-100">
              <span className="hidden sm:inline">TRAX & SolvAlrm coming soon!</span>
            </a>{' '}
            <br></br>
            <br></br>Besides that, I am an avid music lover who's always looking for something new
            to listen to. Feel free to reach out about new opportunities (or music suggestions)!{' '}
          </p>
        </p>
        {/*div that creates SVG for profile links */}
        <div className="mt-8 flex flex-wrap gap-4 text-center">
          ...
          <a
            ...
            href="mailto:amirabdurazak@gmail.com"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
              <path
                clipRule="evenodd"
          ...
          {/* <a
            className="focusable flex flex-none cursor-pointer items-center justify-center gap-2 rounded-md bg-blue-500 py-2 px-2.5 font-medium text-white shadow-lg shadow-blue-500/10 transition selection:bg-white/30 hover:bg-blue-500/80 hover:shadow-blue-500/5 focus:ring-blue-500/40 dark:bg-blue-400 dark:text-zinc-900 dark:shadow-blue-400/10 dark:selection:bg-zinc-900/30 dark:hover:bg-blue-400/80 dark:hover:shadow-blue-400/5 dark:focus:ring-blue-400/40 sm:w-auto sm:px-3 sm:pl-2.5"
            href="https://twitter.com/raphael"
            rel="noreferrer"
            target="_blank"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="content mb-8">
        ...
        <p className="max-w-[46ch] leading-relaxed text-zinc-500 dark:text-slate-300">
          Various projects I've completed in the last several years.
        </p>
      </div>
      {/* Array that creates the cards based on the projects I have in my projectsData array */}
